...
export const toQueryString = params => {
  ...
  if (TYPE_SALE[params.typeSale]) {
    condition.push(`type_sale=${TYPE_SALE[params.typeSale]}`);
  }

  if (TYPE_HOUSE[params.typeHouse]) {
    console.log('z');
    condition.push(`type_house=${TYPE_HOUSE[params.typeHouse]}`);
    if (TYPE_HOUSE[params.typeHouse] === 'redevelop' || TYPE_HOUSE[params.typeHouse] === 'house') {
      if (TYPE_HOUSE_DETAIL[params.typeHouseDetail]) {
        condition.push(`type_house_detail=${TYPE_HOUSE_DETAIL[params.typeHouseDetail]}`);
      }
    }
  }
